...
/**
 * Send gift premium welcome email — warm light theme
 * Called when admin gifts premium to a user
 */
async function sendGiftPremiumEmail(userEmail, plan) {
  try {
    const planDisplay = plan === 'annual' ? 'Annual' : 'Monthly';
    const duration = plan === 'annual' ? '1 year' : '1 month';

    const mailOptions = {
      from: { name: 'Seaside Beacon', address: process.env.SENDER_EMAIL || 'forecast@seasidebeacon.com' },
      to: userEmail,
      subject: '🎁 You\'ve Been Gifted Seaside Beacon Premium!',
      headers: {
        'List-Unsubscribe': `<${getUnsubscribeUrl(userEmail)}>`,
        'List-Unsubscribe-Post': 'List-Unsubscribe=One-Click'
      },
...
<body style="margin:0;padding:0;background-color:#f5f0ea;-webkit-text-size-adjust:none;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#f5f0ea">
    <tr><td align="center" style="padding:32px 16px;">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;">
        ...
        <tr><td bgcolor="#C4733A" style="padding:52px 40px 42px;text-align:center;">
          ...
          <p style="margin:0 0 6px;font-family:'Instrument Sans',-apple-system,BlinkMacSystemFont,sans-serif;font-size:11px;font-weight:500;text-transform:uppercase;letter-spacing:3px;color:#f5e8d8;">You've been gifted</p>
          <h1 style="margin:0 0 8px;font-family:'Cormorant Garamond',Georgia,serif;font-size:36px;font-weight:600;color:#ffffff;letter-spacing:-0.5px;">Seaside Beacon Premium</h1>

          <!-- Premium badge -->
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:8px auto 0;">
            <tr><td bgcolor="#A05A2A" style="border:1px solid #D4924A;padding:5px 18px;">
              <span style="font-family:'Instrument Sans',-apple-system,BlinkMacSystemFont,sans-serif;font-size:10px;font-weight:600;letter-spacing:3px;text-transform:uppercase;color:#FFE0C0;">★ Premium Gift</span>
            </td></tr>
          </table>
        ...
        <tr><td bgcolor="#ffffff" style="padding:0;">
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr><td style="padding:36px 40px 0;text-align:center;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 auto;">
                <tr><td bgcolor="#FDF5EE" style="border:1px solid #E8D5C0;padding:8px 22px;">
                  <span style="font-family:'Instrument Sans',-apple-system,BlinkMacSystemFont,sans-serif;font-size:13px;font-weight:500;color:#c4733a;letter-spacing:0.3px;">🎫 ${planDisplay} plan · ${duration} free</span>
                </td></tr>
              </table>
            </td></tr>
          </table>
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr><td style="padding:28px 40px 0;text-align:center;">
              <h2 style="margin:0 0 16px;font-family:'Cormorant Garamond',Georgia,serif;font-size:26px;font-weight:500;color:#2a2420;letter-spacing:-0.3px;">Congratulations!</h2>
              <p style="margin:0;font-family:'Instrument Sans',-apple-system,BlinkMacSystemFont,sans-serif;font-size:14px;line-height:1.75;color:#6b6058;">Someone at Seaside Beacon thinks you deserve the full sunrise experience. Your premium features are active immediately. No payment needed, just enjoy.</p>
            </td></tr>
          </table>
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr><td style="padding:0 40px 40px;text-align:center;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr><td bgcolor="#FDF5EE" style="border:1px solid #E8D5C0;padding:22px 24px;text-align:center;">
                  <p style="margin:0 0 10px;font-family:'Cormorant Garamond',Georgia,serif;font-size:18px;font-weight:600;color:#2a2420;">Ready to explore?</p>
                  <p style="margin:0 0 16px;font-family:'Instrument Sans',-apple-system,BlinkMacSystemFont,sans-serif;font-size:12px;line-height:1.6;color:#8a7e72;">Visit the website, pick your beach, and start planning your sunrise week.</p>
                  <a href="${APP_URL}" style="display:inline-block;background-color:#C4733A;color:#ffffff;font-family:'Instrument Sans',-apple-system,BlinkMacSystemFont,sans-serif;font-size:13px;font-weight:600;text-decoration:none;padding:10px 28px;letter-spacing:0.5px;">View Forecasts</a>
                </td></tr>
              </table>
            </td></tr>
          </table>
    ...
    const info = await sendEmail(mailOptions);
    console.log(`✅ Gift premium email sent to ${userEmail} via ${EMAIL_PROVIDER}`);
    return { success: true, messageId: info.messageId };
  } catch (error) {
    console.error('❌ Gift premium email error:', error.message);
    throw error;
  }
}

module.exports = { sendWelcomeEmail, sendDailyPredictionEmail, sendEveningPreviewEmail, sendSpecialAlertEmail, sendPremiumWelcomeEmail, sendPaymentReceiptEmail, sendCancellationEmail, sendPasswordResetEmail, sendTestEmail, sendGiftPremiumEmail };